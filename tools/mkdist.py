...
def MkDist_Strip(program, BSP_ROOT, RTT_ROOT, Env):
    ...
    import txconfig
    print('=> %s' % (os.path.join('libcpu', txconfig.ARCH, txconfig.CPU)))
    do_copy_folder(os.path.join(RTT_ROOT, 'libcpu', txconfig.ARCH, txconfig.CPU), os.path.join(target_path, 'libcpu', txconfig.ARCH, txconfig.CPU))
    if os.path.exists(os.path.join(RTT_ROOT, 'libcpu', txconfig.ARCH, 'common')):
        print('=> %s' % (os.path.join('libcpu', txconfig.ARCH, 'common')))
        do_copy_folder(os.path.join(RTT_ROOT, 'libcpu', txconfig.ARCH, 'common'), os.path.join(target_path, 'libcpu', txconfig.ARCH, 'common'))
...
def MkDist(program, BSP_ROOT, RTT_ROOT, Env):
    ...
    print('=> libcpu')
    import txconfig
    do_copy_folder(os.path.join(RTT_ROOT, 'libcpu', txconfig.ARCH), os.path.join(target_path, 'libcpu', txconfig.ARCH))
    do_copy_file(os.path.join(RTT_ROOT, 'libcpu', 'Kconfig'), os.path.join(target_path, 'libcpu', 'Kconfig'))
    do_copy_file(os.path.join(RTT_ROOT, 'libcpu', 'SConscript'), os.path.join(target_path, 'libcpu', 'SConscript'))
