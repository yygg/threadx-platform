 ...
 * Change Logs:
 * Date           Author       Notes
 * 2020-07-21     Urey       the first version
 */
#ifndef PACKAGES_TX_DEBUG_TX_DBG_H_
#define PACKAGES_TX_DEBUG_TX_DBG_H_

#if !defined(DBG_ENABLE)
#define DBG_ENABLE
#endif

#if !defined(DBG_COLOR)
#define DBG_COLOR
#endif
...
#endif /* PACKAGES_TX_DEBUG_TX_DBG_H_ */
